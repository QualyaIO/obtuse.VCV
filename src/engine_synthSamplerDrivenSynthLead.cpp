...
void synthSamplerDrivenSynthLead_Processor__ctx_type_2_init(synthSamplerDrivenSynthLead_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerDrivenSynthLead_Util__ctx_type_3_init(_ctx._inst193b);
   synthSamplerDrivenSynthLead_Util__ctx_type_3_init(_ctx._inst163b);
   synthSamplerDrivenSynthLead_Util__ctx_type_3_init(_ctx._inst133b);
