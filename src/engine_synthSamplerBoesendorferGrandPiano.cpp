...
void synthSamplerBoesendorferGrandPiano_Notes__ctx_type_0_init(synthSamplerBoesendorferGrandPiano_Notes__ctx_type_0 &_output_){
   synthSamplerBoesendorferGrandPiano_Notes__ctx_type_0 _ctx;
   _ctx.poly = false;
...
void synthSamplerBoesendorferGrandPiano_Poly__ctx_type_0_init(synthSamplerBoesendorferGrandPiano_Poly__ctx_type_0 &_output_){
   synthSamplerBoesendorferGrandPiano_Poly__ctx_type_0 _ctx;
...
void synthSamplerBoesendorferGrandPiano_Voice__ctx_type_0_init(synthSamplerBoesendorferGrandPiano_Voice__ctx_type_0 &_output_){
   synthSamplerBoesendorferGrandPiano_Voice__ctx_type_0 _ctx;
...
void synthSamplerBoesendorferGrandPiano_Processor_setNote(synthSamplerBoesendorferGrandPiano_Processor__ctx_type_2 &_ctx, fix16_t gate, fix16_t voct, fix16_t vel, fix16_t retrigger, int cable){
   ...
   if(bool_not(_ctx.last_gates[cable]) && (gate >= 0x1999 /* 0.100000 */)){
      ...
      _ctx.last_pitches[cable] = (1 + synthSamplerBoesendorferGrandPiano_Processor_cvToPitch(voct));
      _ctx.last_retrigger[cable] = true;
      synthSamplerBoesendorferGrandPiano_Voice_noteOn(_ctx.voice,((-1) + _ctx.last_pitches[cable]),fix_to_int(velocity),0);
   }
   else
   {
      if(_ctx.last_gates[cable] && (gate < 0x1999 /* 0.100000 */)){
         if(_ctx.last_pitches[cable] > 0){
            synthSamplerBoesendorferGrandPiano_Voice_noteOff(_ctx.voice,((-1) + _ctx.last_pitches[cable]),0);
         }
   ...
   if(nbcables != _ctx.last_nbcables){
      ...
      while((c < 16) && (c < 16)){
         if(_ctx.last_gates[c] && (_ctx.last_pitches[c] > 0)){
            synthSamplerBoesendorferGrandPiano_Voice_noteOff(_ctx.voice,((-1) + _ctx.last_pitches[c]),0);
         }
