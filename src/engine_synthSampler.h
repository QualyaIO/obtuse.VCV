...
static_inline void synthSampler_Util__ctx_type_2_init(synthSampler_Util__ctx_type_2 &_output_){
   synthSampler_Util__ctx_type_2 _ctx;
   _ctx.pre = false;
   _output_ = _ctx;
   return ;
}
...
static_inline void synthSampler_Util__ctx_type_5_init(synthSampler_Util__ctx_type_5 &_output_){
   synthSampler_Util__ctx_type_5 _ctx;
   _ctx.x = 0x0 /* 0.000000 */;
   _output_ = _ctx;
   return ;
}
...
typedef struct synthSampler_Processor__ctx_type_2 {
   ...
   fix16_t fs;
   synthSampler_Util__ctx_type_4 _inst233b;
   synthSampler_Util__ctx_type_4 _inst203b;
   synthSampler_Util__ctx_type_4 _inst173b;
...
void synthSampler_Processor_setNote(synthSampler_Processor__ctx_type_2 &_ctx, fix16_t gate, fix16_t voct, fix16_t vel, fix16_t retrigger, int cable);

typedef synthSampler_Processor__ctx_type_2 synthSampler_Processor_setPitchBend_type;

static_inline void synthSampler_Processor_setPitchBend_init(synthSampler_Processor__ctx_type_2 &_output_){
   synthSampler_Processor__ctx_type_2_init(_output_);
   return ;
}

static_inline void synthSampler_Processor_setPitchBend(synthSampler_Processor__ctx_type_2 &_ctx, fix16_t semitones){
   synthSampler_Voice_synthPitchBend(_ctx.voice,semitones);
};
...
static_inline void synthSampler_Processor_setLoop(synthSampler_Processor__ctx_type_2 &_ctx, uint8_t param, uint8_t force){
   if(synthSampler_Util_change(_ctx._inst173b,synthSampler_Processor_bool2real(param)) || force){
...
static_inline void synthSampler_Processor_setLoopStart(synthSampler_Processor__ctx_type_2 &_ctx, int param, uint8_t force){
   if(synthSampler_Util_change(_ctx._inst203b,int_to_fix(param)) || force){
...
static_inline void synthSampler_Processor_setLoopEnd(synthSampler_Processor__ctx_type_2 &_ctx, int param, uint8_t force){
   if(synthSampler_Util_change(_ctx._inst233b,int_to_fix(param)) || force){
...
static_inline void synthSampler_Processor_default(synthSampler_Processor__ctx_type_2 &_ctx){
   ...
   synthSampler_Voice_setReuse(_ctx.voice,true);
}
