...
void synthSamplerVocalCluster_Processor__ctx_type_2_init(synthSamplerVocalCluster_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerVocalCluster_Util__ctx_type_4_init(_ctx._inst233b);
   synthSamplerVocalCluster_Util__ctx_type_4_init(_ctx._inst203b);
   synthSamplerVocalCluster_Util__ctx_type_4_init(_ctx._inst173b);
