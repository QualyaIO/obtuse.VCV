...
void synthSamplerIndianSitar_Processor__ctx_type_2_init(synthSamplerIndianSitar_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerIndianSitar_Util__ctx_type_4_init(_ctx._inst233b);
   synthSamplerIndianSitar_Util__ctx_type_4_init(_ctx._inst203b);
   synthSamplerIndianSitar_Util__ctx_type_4_init(_ctx._inst173b);
