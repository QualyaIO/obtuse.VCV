...
void synthSamplerGlassMarimbaSoft_Processor__ctx_type_2_init(synthSamplerGlassMarimbaSoft_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerGlassMarimbaSoft_Util__ctx_type_3_init(_ctx._inst193b);
   synthSamplerGlassMarimbaSoft_Util__ctx_type_3_init(_ctx._inst163b);
   synthSamplerGlassMarimbaSoft_Util__ctx_type_3_init(_ctx._inst133b);
...
void synthSamplerGlassMarimbaSoft_Processor_setNote(synthSamplerGlassMarimbaSoft_Processor__ctx_type_2 &_ctx, fix16_t gate, fix16_t voct, fix16_t vel, int cable){
   ...
   if(bool_not(_ctx.last_gates[cable]) && (gate >= 0x1999 /* 0.100000 */)){
      ...
      _ctx.last_pitches[cable] = synthSamplerGlassMarimbaSoft_Processor_cvToPitch(voct);
      synthSamplerGlassMarimbaSoft_Voice_noteOn(_ctx.voice,_ctx.last_pitches[cable],fix_to_int(velocity),0);
   }
   else
   {
      if(_ctx.last_gates[cable] && (gate < 0x1999 /* 0.100000 */)){
         if(_ctx.last_pitches[cable] >= 0){
            synthSamplerGlassMarimbaSoft_Voice_noteOff(_ctx.voice,_ctx.last_pitches[cable],0);
         }
   ...
   if(nbcables != _ctx.last_nbcables){
      ...
      while((c < 16) && (c < 16)){
         if(_ctx.last_gates[c] && (_ctx.last_pitches[c] >= 0)){
            synthSamplerGlassMarimbaSoft_Voice_noteOff(_ctx.voice,_ctx.last_pitches[c],0);
         }
