...
void synthSamplerShootingStar_Notes__ctx_type_0_init(synthSamplerShootingStar_Notes__ctx_type_0 &_output_){
   synthSamplerShootingStar_Notes__ctx_type_0 _ctx;
   _ctx.poly = false;
...
void synthSamplerShootingStar_Poly__ctx_type_0_init(synthSamplerShootingStar_Poly__ctx_type_0 &_output_){
   synthSamplerShootingStar_Poly__ctx_type_0 _ctx;
...
void synthSamplerShootingStar_Voice__ctx_type_0_init(synthSamplerShootingStar_Voice__ctx_type_0 &_output_){
   synthSamplerShootingStar_Voice__ctx_type_0 _ctx;
...
void synthSamplerShootingStar_Processor__ctx_type_2_init(synthSamplerShootingStar_Processor__ctx_type_2 &_output_){
   synthSamplerShootingStar_Processor__ctx_type_2 _ctx;
   synthSamplerShootingStar_Voice__ctx_type_0_init(_ctx.voice);
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerShootingStar_Util__ctx_type_4_init(_ctx._inst243b);
   synthSamplerShootingStar_Util__ctx_type_4_init(_ctx._inst213b);
   synthSamplerShootingStar_Util__ctx_type_4_init(_ctx._inst183b);
   synthSamplerShootingStar_Processor_default(_ctx);
   _output_ = _ctx;
   return ;
}
...
void synthSamplerShootingStar_Processor_setNote(synthSamplerShootingStar_Processor__ctx_type_2 &_ctx, fix16_t gate, fix16_t voct, fix16_t vel, fix16_t retrigger, int cable){
   ...
   if(bool_not(_ctx.last_gates[cable]) && (gate >= 0x1999 /* 0.100000 */)){
      ...
      _ctx.last_pitches[cable] = (1 + synthSamplerShootingStar_Processor_cvToPitch(voct));
      _ctx.last_retrigger[cable] = true;
      synthSamplerShootingStar_Voice_noteOn(_ctx.voice,((-1) + _ctx.last_pitches[cable]),fix_to_int(velocity),0);
   }
   else
   {
      if(_ctx.last_gates[cable] && (gate < 0x1999 /* 0.100000 */)){
         if(_ctx.last_pitches[cable] > 0){
            synthSamplerShootingStar_Voice_noteOff(_ctx.voice,((-1) + _ctx.last_pitches[cable]),0);
         }
   ...
   if((gate >= 0x1999 /* 0.100000 */) && bool_not(_ctx.last_retrigger[cable]) && (retrigger >= 0x1999 /* 0.100000 */)){
      int new_pitch;
      new_pitch = (1 + synthSamplerShootingStar_Processor_cvToPitch(voct));
   ...
   if(nbcables != _ctx.last_nbcables){
      ...
      while((c < 16) && (c < 16)){
         if(_ctx.last_gates[c] && (_ctx.last_pitches[c] > 0)){
            synthSamplerShootingStar_Voice_noteOff(_ctx.voice,((-1) + _ctx.last_pitches[c]),0);
         }
