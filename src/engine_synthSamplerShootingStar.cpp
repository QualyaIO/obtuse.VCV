...
void synthSamplerShootingStar_Processor__ctx_type_2_init(synthSamplerShootingStar_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerShootingStar_Util__ctx_type_4_init(_ctx._inst233b);
   synthSamplerShootingStar_Util__ctx_type_4_init(_ctx._inst203b);
   synthSamplerShootingStar_Util__ctx_type_4_init(_ctx._inst173b);
