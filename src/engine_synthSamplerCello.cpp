...
void synthSamplerCello_Notes__ctx_type_0_init(synthSamplerCello_Notes__ctx_type_0 &_output_){
   synthSamplerCello_Notes__ctx_type_0 _ctx;
   _ctx.poly = false;
...
void synthSamplerCello_Sampler__ctx_type_0_init(synthSamplerCello_Sampler__ctx_type_0 &_output_){
   synthSamplerCello_Sampler__ctx_type_0 _ctx;
...
void synthSamplerCello_Poly__ctx_type_0_init(synthSamplerCello_Poly__ctx_type_0 &_output_){
   synthSamplerCello_Poly__ctx_type_0 _ctx;
...
void synthSamplerCello_Voice__ctx_type_0_init(synthSamplerCello_Voice__ctx_type_0 &_output_){
   synthSamplerCello_Voice__ctx_type_0 _ctx;
...
void synthSamplerCello_Processor__ctx_type_2_init(synthSamplerCello_Processor__ctx_type_2 &_output_){
   synthSamplerCello_Processor__ctx_type_2 _ctx;
   synthSamplerCello_Voice__ctx_type_0_init(_ctx.voice);
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerCello_Util__ctx_type_4_init(_ctx._inst233b);
   synthSamplerCello_Util__ctx_type_4_init(_ctx._inst203b);
   synthSamplerCello_Util__ctx_type_4_init(_ctx._inst173b);
   synthSamplerCello_Processor_default(_ctx);
   _output_ = _ctx;
   return ;
}
...
void synthSamplerCello_Processor_setNote(synthSamplerCello_Processor__ctx_type_2 &_ctx, fix16_t gate, fix16_t voct, fix16_t vel, fix16_t retrigger, int cable){
   ...
   if(bool_not(_ctx.last_gates[cable]) && (gate >= 0x1999 /* 0.100000 */)){
      ...
      _ctx.last_pitches[cable] = (1 + synthSamplerCello_Processor_cvToPitch(voct));
      _ctx.last_retrigger[cable] = true;
      synthSamplerCello_Voice_noteOn(_ctx.voice,((-1) + _ctx.last_pitches[cable]),fix_to_int(velocity),0);
   }
   else
   {
      if(_ctx.last_gates[cable] && (gate < 0x1999 /* 0.100000 */)){
         if(_ctx.last_pitches[cable] > 0){
            synthSamplerCello_Voice_noteOff(_ctx.voice,((-1) + _ctx.last_pitches[cable]),0);
         }
   ...
   if(nbcables != _ctx.last_nbcables){
      ...
      while((c < 16) && (c < 16)){
         if(_ctx.last_gates[c] && (_ctx.last_pitches[c] > 0)){
            synthSamplerCello_Voice_noteOff(_ctx.voice,((-1) + _ctx.last_pitches[c]),0);
         }
