...
void synthSamplerCelesta_Processor__ctx_type_2_init(synthSamplerCelesta_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerCelesta_Util__ctx_type_3_init(_ctx._inst193b);
   synthSamplerCelesta_Util__ctx_type_3_init(_ctx._inst163b);
   synthSamplerCelesta_Util__ctx_type_3_init(_ctx._inst133b);
