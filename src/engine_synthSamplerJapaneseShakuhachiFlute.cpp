...
void synthSamplerJapaneseShakuhachiFlute_Processor__ctx_type_2_init(synthSamplerJapaneseShakuhachiFlute_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerJapaneseShakuhachiFlute_Util__ctx_type_3_init(_ctx._inst193b);
   synthSamplerJapaneseShakuhachiFlute_Util__ctx_type_3_init(_ctx._inst163b);
   synthSamplerJapaneseShakuhachiFlute_Util__ctx_type_3_init(_ctx._inst133b);
