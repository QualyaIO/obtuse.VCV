...
void synthSamplerCosmos_Notes__ctx_type_0_init(synthSamplerCosmos_Notes__ctx_type_0 &_output_){
   synthSamplerCosmos_Notes__ctx_type_0 _ctx;
   _ctx.poly = false;
...
void synthSamplerCosmos_Poly__ctx_type_0_init(synthSamplerCosmos_Poly__ctx_type_0 &_output_){
   synthSamplerCosmos_Poly__ctx_type_0 _ctx;
...
void synthSamplerCosmos_Voice__ctx_type_0_init(synthSamplerCosmos_Voice__ctx_type_0 &_output_){
   synthSamplerCosmos_Voice__ctx_type_0 _ctx;
...
void synthSamplerCosmos_Processor__ctx_type_2_init(synthSamplerCosmos_Processor__ctx_type_2 &_output_){
   synthSamplerCosmos_Processor__ctx_type_2 _ctx;
   synthSamplerCosmos_Voice__ctx_type_0_init(_ctx.voice);
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerCosmos_Util__ctx_type_4_init(_ctx._inst233b);
   synthSamplerCosmos_Util__ctx_type_4_init(_ctx._inst203b);
   synthSamplerCosmos_Util__ctx_type_4_init(_ctx._inst173b);
   synthSamplerCosmos_Processor_default(_ctx);
   _output_ = _ctx;
   return ;
}
