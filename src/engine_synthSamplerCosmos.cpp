...
void synthSamplerCosmos_Processor__ctx_type_2_init(synthSamplerCosmos_Processor__ctx_type_2 &_output_){
   ...
   _ctx.fs = 0x0 /* 0.000000 */;
   synthSamplerCosmos_Util__ctx_type_4_init(_ctx._inst243b);
   synthSamplerCosmos_Util__ctx_type_4_init(_ctx._inst213b);
   synthSamplerCosmos_Util__ctx_type_4_init(_ctx._inst183b);
...
void synthSamplerCosmos_Processor_setNote(synthSamplerCosmos_Processor__ctx_type_2 &_ctx, fix16_t gate, fix16_t voct, fix16_t vel, fix16_t retrigger, int cable){
   ...
   if((gate >= 0x1999 /* 0.100000 */) && bool_not(_ctx.last_retrigger[cable]) && (retrigger >= 0x1999 /* 0.100000 */)){
      int new_pitch;
      new_pitch = (1 + synthSamplerCosmos_Processor_cvToPitch(voct));
