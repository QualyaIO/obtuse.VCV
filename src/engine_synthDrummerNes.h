...
static_inline void synthDrummerNes_Util__ctx_type_2_init(synthDrummerNes_Util__ctx_type_2 &_output_){
   synthDrummerNes_Util__ctx_type_2 _ctx;
   _ctx.pre = false;
   _output_ = _ctx;
   return ;
}
...
static_inline void synthDrummerNes_Util__ctx_type_5_init(synthDrummerNes_Util__ctx_type_5 &_output_){
   synthDrummerNes_Util__ctx_type_5 _ctx;
   _ctx.x = 0x0 /* 0.000000 */;
   _output_ = _ctx;
   return ;
}
...
typedef synthDrummerNes_Processor__ctx_type_1 synthDrummerNes_Processor_setPitchBend_type;

static_inline void synthDrummerNes_Processor_setPitchBend_init(synthDrummerNes_Processor__ctx_type_1 &_output_){
   synthDrummerNes_Processor__ctx_type_1_init(_output_);
   return ;
}

static_inline void synthDrummerNes_Processor_setPitchBend(synthDrummerNes_Processor__ctx_type_1 &_ctx, fix16_t semitones){
   synthDrummerNes_Voice_synthPitchBend(_ctx.voice,semitones);
};
